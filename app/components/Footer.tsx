      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:contato@empresa.com" className="hover:text-purple-400">
                  contato@empresa.com
                </a>
              </li>
              <li className="flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/tickets" className="hover:text-purple-400">
                  Suporte
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/politica-privacidade" className="hover:text-purple-400">
                  Política de Privacidade
                </Link>
              </li>
              <li>
                <Link href="/termos-uso" className="hover:text-purple-400">
                  Termos de Uso
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-sm text-gray-400">
            © {currentYear} Sistema de Rastreamento. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
